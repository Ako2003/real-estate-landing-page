        ...
        <section className="flex items-end">
            <div className="bg-brown w-full">
                <div className="flex flex-col items-center pb-30">
                    ...
                    <h6 className="!text-yellow max-w-md w-11/12 mx-auto max-lg:text-center mb-10">Please submit your contact information and one of our sales
...
export function Form() {
    return (
        <form>
            <div className="flex max-lg:flex-col justify-between gap-10 max-lg:w-xs">
                <div className="flex flex-col w-full">
                    <label className="!text-yellow font-madefor-display" htmlFor="firstName">First name *</label>
                    <input type="text" className="!text-yellow ring-0 outline-0 border-b mt-5 pl-3 pb-1 font-madefor-display w-full" required/>
                </div>
                <div className="flex flex-col w-full">
            ...
            <div className="flex max-lg:flex-col justify-between gap-5 mt-10">
                <div className="flex flex-col w-full">
...
export function Rights() {
    return (
        <footer className="bg-brown w-full">
            <div className="pb-10 max-w-4xl mx-auto flex max-md:flex-col justify-between">
